...
const categories = [
    ...
    { name: "Contacts", icon: <FaUserFriends />, color: "bg-blue-200 text-blue-700", path:"/client-locations" },
    ...
    { name: "Locations", icon: <FaLocationArrow />, color: "bg-orange-200 text-orange-700", path:"client-data" },
    ...
    { name: "Marketing", icon: <FaSalesforce />, color: "bg-pink-200 text-pink-700" },
